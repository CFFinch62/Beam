...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    tCHOMP = 411,                  /* tCHOMP  */
    tSYSTEM = 412,                 /* tSYSTEM  */
    tSYSTEM2 = 413,                /* tSYSTEM2  */
    tPEEK = 414,                   /* tPEEK  */
    tPEEK2 = 415,                  /* tPEEK2  */
    tPOKE = 416,                   /* tPOKE  */
    tFRNFN_CALL = 417,             /* tFRNFN_CALL  */
    tFRNFN_CALL2 = 418,            /* tFRNFN_CALL2  */
    tFRNFN_SIZE = 419,             /* tFRNFN_SIZE  */
    tFRNBF_ALLOC = 420,            /* tFRNBF_ALLOC  */
    tFRNBF_FREE = 421,             /* tFRNBF_FREE  */
    tFRNBF_SIZE = 422,             /* tFRNBF_SIZE  */
    tFRNBF_DUMP = 423,             /* tFRNBF_DUMP  */
    tFRNBF_SET = 424,              /* tFRNBF_SET  */
    tFRNBF_GET = 425,              /* tFRNBF_GET  */
    tFRNBF_GET2 = 426,             /* tFRNBF_GET2  */
    tFRNBF_GET_BUFFER = 427,       /* tFRNBF_GET_BUFFER  */
    tFRNBF_SET_BUFFER = 428,       /* tFRNBF_SET_BUFFER  */
    tDATE = 429,                   /* tDATE  */
    tTIME = 430,                   /* tTIME  */
    tTOKEN = 431,                  /* tTOKEN  */
    tTOKENALT = 432,               /* tTOKENALT  */
    tSPLIT = 433,                  /* tSPLIT  */
    tSPLITALT = 434,               /* tSPLITALT  */
    tGLOB = 435,                   /* tGLOB  */
    tSTART_PROGRAM = 436,          /* tSTART_PROGRAM  */
    tSTART_EXPRESSION = 437,       /* tSTART_EXPRESSION  */
    tSTART_STRING_EXPRESSION = 438, /* tSTART_STRING_EXPRESSION  */
    tSTART_ASSIGNMENT = 439,       /* tSTART_ASSIGNMENT  */
