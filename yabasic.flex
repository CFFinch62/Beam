...
BEAM_OPEN return tBEAM_OPEN;
BEAM_CLOSE return tBEAM_CLOSE;
BEAM_TITLE return tBEAM_TITLE;
BEAM_SIZE return tBEAM_SIZE;
BEAM_RUNNING return tBEAM_RUNNING;
BEAM_BEGIN return tBEAM_BEGIN;
BEAM_END return tBEAM_END;
BEAM_BUTTON return tBEAM_BUTTON;
BEAM_LABEL return tBEAM_LABEL;
BEAM_TEXT return tBEAM_TEXT;
BEAM_INPUT return tBEAM_INPUT;
BEAM_CHECKBOX return tBEAM_CHECKBOX;
BEAM_COMBO return tBEAM_COMBO;
BEAM_SLIDER return tBEAM_SLIDER;
BEAM_PROGRESS return tBEAM_PROGRESS;
BEAM_VBAR return tBEAM_VBAR;
BEAM_SEPARATOR return tBEAM_SEPARATOR;
BEAM_SPACING return tBEAM_SPACING;
BEAM_IMAGE return tBEAM_IMAGE;
BEAM_ROW_END return tBEAM_ROW_END;
BEAM_ROW return tBEAM_ROW;
BEAM_GROUP_BEGIN return tBEAM_GROUP_BEGIN;
BEAM_GROUP_END return tBEAM_GROUP_END;
BEAM_PANEL_BEGIN return tBEAM_PANEL_BEGIN;
BEAM_PANEL_END return tBEAM_PANEL_END;
BEAM_MSGBOX return tBEAM_MSGBOX;
BEAM_CONFIRM return tBEAM_CONFIRM;
BEAM_OPEN_FILE return tBEAM_OPEN_FILE;
BEAM_SAVE_FILE return tBEAM_SAVE_FILE;
BEAM_SET_COLOR return tBEAM_SET_COLOR;
BEAM_SET_STYLE return tBEAM_SET_STYLE;
BEAM_TIME return tBEAM_TIME;
BEAM_SLEEP return tBEAM_SLEEP;
BEAM_NMEA_OPEN return tBEAM_NMEA_OPEN;
BEAM_NMEA_CLOSE return tBEAM_NMEA_CLOSE;
BEAM_NMEA_READ return tBEAM_NMEA_READ;
BEAM_NMEA_FIELD return tBEAM_NMEA_FIELD;
