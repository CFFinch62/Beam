...
SHORTCUTS = [
    ...
    ("Edit", "Find", "Ctrl+F"),
    ("Edit", "Replace", "Ctrl+H"),
    ("Edit", "Comment/Uncomment", "Ctrl+/"),
    ("Edit", "Preferences", "Ctrl+,"),
    ("View", "Toggle File Browser", "Ctrl+B"),
    ("View", "Toggle Terminal", "Ctrl+`"),
    ("Run", "Run", "F5"),
    ("Run", "Run External", "Ctrl+F5"),
    ("Run", "Stop", "Shift+F5"),
    ("Help", "BEAM Reference", "F1"),
]


class SettingsDialog(QDialog):
    """Preferences dialog for BEAM IDE settings"""
    ...
    def _create_theme_tab(self) -> QWidget:
        ...
        ui_layout.addWidget(self.ui_theme_combo)
        ui_group.setLayout(ui_layout)
        layout.addWidget(ui_group)

        syntax_group = QGroupBox("Syntax Theme")
        ...
        syntax_layout.addWidget(self.syntax_theme_combo)
    ...
    def _create_runtime_tab(self) -> QWidget:
        tab = QWidget()
        layout = QVBoxLayout(tab)
        interpreter_group = QGroupBox("BEAM Interpreter")
        interpreter_layout = QVBoxLayout()
        lbl = QLabel("Path to 'beam' executable:")
    ...
    def _load_current_settings(self):
        ...
        self.interpreter_path_input.setText(s.beam_interpreter_path)
    ...
    def _update_preview(self):
        ...
        if ui_theme_name and syntax_theme_name:
            ...
            """)
            sample_html = f'''
                <span style="color: {syntax_theme.keyword};">sub</span>
                <span style="color: {syntax_theme.function};">greet</span>
                <span style="color: {ui_theme.foreground};">(</span>
                <span style="color: {syntax_theme.identifier};">name$</span>
                <span style="color: {ui_theme.foreground};">)</span><br>
                &nbsp;&nbsp;<span style="color: {syntax_theme.builtin};">beam_label</span>
                <span style="color: {syntax_theme.string};">"Hello, BEAM!"</span><br>
                <span style="color: {syntax_theme.comment};">\' Theme preview</span>
            '''
    ...
    def _apply_settings(self):
        ...
        if new_ui_theme:
            ...
            s.theme.current_theme = new_ui_theme
        ...
        s.beam_interpreter_path = self.interpreter_path_input.text().strip()
