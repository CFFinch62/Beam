...
def get_config_dir() -> Path:
    """Get the configuration directory for BEAM IDE"""
    config_dir = Path.home() / ".config" / "beam_ide"
...
class SettingsManager:
    ...
    def _dict_to_settings(self, data: dict) -> Settings:
        ...
        if 'beam_interpreter_path' in data:
            settings.beam_interpreter_path = data['beam_interpreter_path']
    ...
    def save(self):
        ...
        data = {
            ...
            'beam_interpreter_path': self.settings.beam_interpreter_path,
